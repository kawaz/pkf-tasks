...
Pin to `pkf-tasks@2` for major-only floating, or to an exact version (e.g. `pkf-tasks@2.2.0`) for full reproducibility. The `migrate:check-*` gates keep the pin up to date regardless.
